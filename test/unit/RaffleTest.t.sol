...
contract RaffleTest is Test {
    ...
    function testUpkeepReturnsFalseIfNoBalanceAvailableInRaffle() public {
        //Arrange
        vm.warp(block.timestamp + interval + 1);
        vm.roll(block.number + 1);
        //Act
    ...
    function testUpkeepReturnsTrueIfAllConditionsAreGood() public {
        //Arrange
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
        vm.warp(block.timestamp + interval + 1);
    ...
    function testPerformUpkeepRevertsIfCheckUpKeepsIsFalse() public {
        ...
        //Act/Assert
        vm.expectRevert(
            abi.encodeWithSelector(Raffle.Raffle__NotUpKeepNeeded.selector, currentBalance, numPlayers, rState)
        );
        raffle.performUpKeep("");
    }
    ...
    function testFulfillRandomWordsPicksWinnerResetsAndSendMoney() public enterRaffle {
        //Arrange
